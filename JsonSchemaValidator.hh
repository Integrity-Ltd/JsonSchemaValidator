...
public:
	...
	explicit Reference(const Reference &);
	...
	void remap(const Reference & r);
	void forward(const std::string &pos);
};
...
private:
	...
	Reference getReferece(const Json::Value &, const std::string &);
	...
	void validateBoolean(const Reference &);
